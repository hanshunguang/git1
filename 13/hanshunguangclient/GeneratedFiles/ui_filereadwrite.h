...
public:
    ...
    {
        filereadwrite->setWindowTitle(QApplication::translate("filereadwrite", "filereadwrite", Q_NULLPTR));
        pushButton_2->setText(QApplication::translate("filereadwrite", "read", Q_NULLPTR));
        pushButton->setText(QApplication::translate("filereadwrite", "change", Q_NULLPTR));
    } // retranslateUi
